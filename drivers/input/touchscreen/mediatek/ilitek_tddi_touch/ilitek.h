...
#define ENABLE_GESTURE			ENABLE//DISABLE
...
//#define INI_NAME_PATH			"/vendor/firmware/mp_xl.ini"
...
#define XL_ROW_INI_NAME_PATH			       "/vendor/firmware/mp_xl_row.ini"
#define TXD_ROW_INI_NAME_PATH			"/vendor/firmware/mp_txd_row.ini"
#define XL_NA_INI_NAME_PATH			      "/vendor/firmware/mp_xl_na.ini"
#define TXD_NA_INI_NAME_PATH			      "/vendor/firmware/mp_txd_na.ini"

#define  XL_ROW_MODULE_NAME_PATH	 "/vendor/firmware/ILITEK_FW_XL_ROW.bin"
#define  XL_NA_MODULE_NAME_PATH	 "/vendor/firmware/ILITEK_FW_XL_NA.bin"
#define  TXD_ROW_MODULE_NAME_PATH	 "/vendor/firmware/ILITEK_FW_TXD_ROW.bin"
#define  TXD_NA_MODULE_NAME_PATH	 "/vendor/firmware/ILITEK_FW_TXD_NA.bin"
#define  XL_MODULE_NAME_PATH	 "/vendor/firmware/ILITEK_FW_XL.bin"
//-add by songbinbo.wt for ILITEK tp driver compatible truly & txd vendor  20191005

#define  ILITEK_TOUCHSCREEN_LOCKDOWN_INFO    //lockdown info
...
enum module_name{
	XL_ROW_MODULE_NAME = 0,
        XL_NA_MODULE_NAME = 1,
 	TXD_ROW_MODULE_NAME = 2,
	TXD_NA_MODULE_NAME = 3,
	XL_MODULE_NAME = 4,
	NONE_NAME = 5,
};
...
#define  GESTURE_DOUBLE_TAP                KEY_HOMEPAGE//KEY_HOME
...
struct ilitek_tddi_dev {
	...
	int last_touch;
	struct work_struct	glove_work_queue; //+ add by songbinbo.wt for High sensitivity mode contrl after suspend resume 20191125
	...
	bool first_irq; /*ritchie add first irq*/
...
static inline void firmware_hd_dma_crc_off_ili9881(void)
{
	/* crc off */
        if(ilitek_ice_mode_write(0x041016, 0x00, 1) < 0){
               ipio_err("Write crc off  failed\n");
        }
	/* dma crc */
        if( ilitek_ice_mode_write(0x041048, 0x00000001, 4) < 0){
               ipio_err("Write dma crc failed\n");
    }
}
...
static inline void firmware_hd_dma_crc_off_ili7807(void)
{
	...
	/* dma crc */
    if(	ilitek_ice_mode_write(0x041017, 0x03, 1) < 0){
        ipio_err("Write dma crc failed\n");
    }
}
