...
//+bug525661 chenbocheng.wt, add, 2020/1/3, add node to control flash light
...
//+bug 491015  , sunhushan.wt, ADD, 2019.10.10, add flashlight device node for factory mode
