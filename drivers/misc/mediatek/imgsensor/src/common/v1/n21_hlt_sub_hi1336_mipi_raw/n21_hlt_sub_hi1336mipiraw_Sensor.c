...
#include "n21_hlt_sub_hi1336mipiraw_Sensor.h"

#define PFX "n21_hlt_sub_hi1336_camera_sensor"
...
extern bool read_n21_hlt_sub_hi1336_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size); 

 //+Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
#define EEPROM_GT24P64B_ID 0xA0
...
static kal_uint16 read_eeprom(kal_uint32 addr)
{
	...
	iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_GT24P64B_ID);
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = N21_HLT_SUB_HI1336_SENSOR_ID,
    ...
    .cap1 = {                            
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 150,
		.mipi_pixel_rate = 285600000,//(726M*4/10)
    },
	.normal_video = {
		.pclk = 600000000,
		.linelength = 6004, 	
	...
	.hs_video = {
		...
		.max_framerate = 1200,
		.mipi_pixel_rate = 96800000, //( 242M*4/10)
	},
    .slim_video = {
		.pclk = 600000000,
		.linelength = 6004,
...
static kal_uint16 n21_hlt_sub_hi1336_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_n21_hlt_sub_hi1336[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
{
#if MULTI_WRITE
	n21_hlt_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_init_n21_hlt_sub_hi1336,
		sizeof(addr_data_pair_init_n21_hlt_sub_hi1336) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x1060, 0x300f); //mipi_static3
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_n21_hlt_sub_hi1336[] = {
	0x3250, 0xa470, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	...
	0x1012, 0x00c9, //mipi_ch0_hblank_delay
	0x1014, 0x0022, //mipi_hblank_short_delay1
	0x1016, 0x0022, //mipi_hblank_short_delay2
	0x101a, 0x0022, //mipi_pd_hblank_delay
...
static void preview_setting(void)
{
#if MULTI_WRITE
	n21_hlt_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_preview_n21_hlt_sub_hi1336,
		sizeof(addr_data_pair_preview_n21_hlt_sub_hi1336) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3250, 0xa470); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	write_cmos_sensor(0x0730, 0x790f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	...
	write_cmos_sensor(0x0f00, 0x0400); //fmt ctrl
        write_cmos_sensor(0x1002, 0xc309);
	...
	write_cmos_sensor(0x1012, 0x00c9); //mipi_ch0_hblank_delay
	write_cmos_sensor(0x1014, 0x0022); //mipi_hblank_short_delay1
	write_cmos_sensor(0x1016, 0x0022); //mipi_hblank_short_delay2
	write_cmos_sensor(0x101a, 0x0022); //mipi_pd_hblank_delay
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_n21_hlt_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	...
	0x1010, 0x07d0, //mipi_vblank_delay
	0x1012, 0x019b, //mipi_ch0_hblank_delay
	0x1014, 0x0079, //mipi_hblank_short_delay1
	0x1016, 0x0079, //mipi_hblank_short_delay2
	0x101a, 0x0079, //mipi_pd_hblank_delay
	0x0404, 0x0008, //x addr start active
	0x0406, 0x1087, //x addr end active
	0x0220, 0x0008, //y addr start fobp
...
kal_uint16 addr_data_pair_capture_15fps_n21_hlt_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	n21_hlt_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_n21_hlt_sub_hi1336,
		sizeof(addr_data_pair_capture_30fps_n21_hlt_sub_hi1336) /
		sizeof(kal_uint16));

	} else {
	n21_hlt_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_n21_hlt_sub_hi1336,
		sizeof(addr_data_pair_capture_15fps_n21_hlt_sub_hi1336) /
		sizeof(kal_uint16));
	}
#else
  if( currefps == 300) {
	  ...
	  write_cmos_sensor(0x1010, 0x07d0); //mipi_vblank_delay
	  write_cmos_sensor(0x1012, 0x019b); //mipi_ch0_hblank_delay
	  write_cmos_sensor(0x1014, 0x0079); //mipi_hblank_short_delay1
	  write_cmos_sensor(0x1016, 0x0079); //mipi_hblank_short_delay2
	  write_cmos_sensor(0x101a, 0x0079); //mipi_pd_hblank_delay
	  write_cmos_sensor(0x0404, 0x0008); //x addr start active
	  write_cmos_sensor(0x0406, 0x1087); //x addr end active
	  write_cmos_sensor(0x0220, 0x0008); //y addr start fobp
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_n21_hlt_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1) 
	0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
...
#if MULTI_WRITE
	n21_hlt_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_video_n21_hlt_sub_hi1336,
		sizeof(addr_data_pair_video_n21_hlt_sub_hi1336) /
		sizeof(kal_uint16));
#else
	  write_cmos_sensor(0x3250, 0xa060); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	  write_cmos_sensor(0x0730, 0x790f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_n21_hlt_sub_hi1336[] = {
	0x3250, 0xa470, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	...
	0x1012, 0x0045, //mipi_ch0_hblank_delay
	0x1014, 0xffed, //mipi_hblank_short_delay1
	0x1016, 0xffed, //mipi_hblank_short_delay2
	0x101a, 0xffed, //mipi_pd_hblank_delay
	0x0404, 0x0008, //x addr start active
	0x0406, 0x1087, //x addr end active
...
#if MULTI_WRITE
	n21_hlt_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_hs_video_n21_hlt_sub_hi1336,
		sizeof(addr_data_pair_hs_video_n21_hlt_sub_hi1336) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_n21_hlt_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	...
	0x102c, 0x1400, //mipi_tpd_sync
	0x1010, 0x07d0, //mipi_vblank_delay
	0x1012, 0x00a6, //mipi_ch0_hblank_delay
	0x1014, 0x0018, //mipi_hblank_short_delay1
	0x1016, 0x0018, //mipi_hblank_short_delay2
	0x101a, 0x0018, //mipi_pd_hblank_delay
	0x0404, 0x0008, //x addr start active
	0x0406, 0x1087, //x addr end active
	0x0220, 0x0008, //y addr start fobp
	0x022a, 0x0017, //y addr end fobp
...
static void slim_video_setting(void)
{
...
#if MULTI_WRITE
	n21_hlt_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_slim_video_n21_hlt_sub_hi1336,
		sizeof(addr_data_pair_slim_video_n21_hlt_sub_hi1336) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3250, 0xa060); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	write_cmos_sensor(0x0730, 0x790f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	...
	write_cmos_sensor(0x102c, 0x1400); //mipi_tpd_sync
	write_cmos_sensor(0x1010, 0x07d0); //mipi_vblank_delay
	write_cmos_sensor(0x1012, 0x00a6); //mipi_ch0_hblank_delay
	write_cmos_sensor(0x1014, 0x0018); //mipi_hblank_short_delay1
	write_cmos_sensor(0x1016, 0x0018); //mipi_hblank_short_delay2
	write_cmos_sensor(0x101a, 0x0018); //mipi_pd_hblank_delay
	write_cmos_sensor(0x0404, 0x0008); //x addr start active
	write_cmos_sensor(0x0406, 0x1087); //x addr end active
	write_cmos_sensor(0x0220, 0x0008); //y addr start fobp
	write_cmos_sensor(0x022a, 0x0017); //y addr end fobp
	...
	write_cmos_sensor(0x0246, 0x0020); //y read dummy address
	write_cmos_sensor(0x020a, 0x033c); //coarse integ time
	write_cmos_sensor(0x021c, 0x0008); //coarse integ time short for iHDR
	write_cmos_sensor(0x0206, 0x05dd); //line length pck
	write_cmos_sensor(0x020e, 0x0340); //frame length lines
...
static struct stCAM_CAL_DATAINFO_STRUCT hlt_sub_hi1336_eeprom_data ={
	.sensorID= N21_HLT_SUB_HI1336_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0E54,
	.sensorVendorid = 0x10020100,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT hlt_sub_hi1336_Checksum[8] =
{
	{MODULE_ITEM,0x0000,0x0000,0x0007,0x0008,0x55},
	{AWB_ITEM,0x0009,0x0009,0x0019,0x001A,0x55},
	{LSC_ITEM,0x0705,0x0705,0x0E51,0x0E52,0x55},
		...
		do {
			*sensor_id = return_sensor_id() +1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
				size = imgSensorReadEepromData(&hlt_sub_hi1336_eeprom_data,hlt_sub_hi1336_Checksum);
				if(size != hlt_sub_hi1336_eeprom_data.dataLength || (hlt_sub_hi1336_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					printk("get eeprom data failed\n");
					if(hlt_sub_hi1336_eeprom_data.dataBuffer != NULL) {
						kfree(hlt_sub_hi1336_eeprom_data.dataBuffer);
						hlt_sub_hi1336_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("get eeprom data success\n");
					imgSensorSetEepromData(&hlt_sub_hi1336_eeprom_data);
				}
				//-Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: n21_hlt_sub_hi1336@MT6765,MIPI 4LANE\n");
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_STREAMING_RESUME:
		...
		read_n21_hlt_sub_hi1336_eeprom((kal_uint16)(*feature_data), 
				(char *)(uintptr_t)(*(feature_data+1)), 
				(kal_uint32)(*(feature_data+2)) );
