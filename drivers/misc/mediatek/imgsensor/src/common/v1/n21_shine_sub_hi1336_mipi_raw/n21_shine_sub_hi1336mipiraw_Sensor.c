...
#include "n21_shine_sub_hi1336mipiraw_Sensor.h"

#define PFX "n21_shine_sub_hi1336_camera_sensor"
...
extern bool read_n21_shine_sub_hi1336_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size); 
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = N21_SHINE_SUB_HI1336_SENSOR_ID,
...
static kal_uint16 n21_shine_sub_hi1336_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_n21_shine_sub_hi1336[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
{
#if MULTI_WRITE
	n21_shine_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_init_n21_shine_sub_hi1336,
		sizeof(addr_data_pair_init_n21_shine_sub_hi1336) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_n21_shine_sub_hi1336[] = {
...
#if MULTI_WRITE
	n21_shine_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_preview_n21_shine_sub_hi1336,
		sizeof(addr_data_pair_preview_n21_shine_sub_hi1336) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_n21_shine_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
kal_uint16 addr_data_pair_capture_15fps_n21_shine_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	n21_shine_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_n21_shine_sub_hi1336,
		sizeof(addr_data_pair_capture_30fps_n21_shine_sub_hi1336) /
		sizeof(kal_uint16));

	} else {
	n21_shine_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_n21_shine_sub_hi1336,
		sizeof(addr_data_pair_capture_15fps_n21_shine_sub_hi1336) /
		sizeof(kal_uint16));
	}
#else
  if( currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_n21_shine_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1) 
	0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
...
#if MULTI_WRITE
	n21_shine_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_video_n21_shine_sub_hi1336,
		sizeof(addr_data_pair_video_n21_shine_sub_hi1336) /
		sizeof(kal_uint16));
#else
	  write_cmos_sensor(0x3250, 0xa060); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	  write_cmos_sensor(0x0730, 0x790f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_n21_shine_sub_hi1336[] = {
	0x3250, 0xa470, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
	n21_shine_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_hs_video_n21_shine_sub_hi1336,
		sizeof(addr_data_pair_hs_video_n21_shine_sub_hi1336) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_n21_shine_sub_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x790f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
	n21_shine_sub_hi1336_table_write_cmos_sensor(
		addr_data_pair_slim_video_n21_shine_sub_hi1336,
		sizeof(addr_data_pair_slim_video_n21_shine_sub_hi1336) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3250, 0xa060); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	write_cmos_sensor(0x0730, 0x790f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
static struct stCAM_CAL_DATAINFO_STRUCT shine_sub_hi1336_eeprom_data ={
	.sensorID= N21_SHINE_SUB_HI1336_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0E54,
	.sensorVendorid = 0x17020100,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT shine_sub_hi1336_Checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
				size = imgSensorReadEepromData(&shine_sub_hi1336_eeprom_data,shine_sub_hi1336_Checksum);
				if(size != shine_sub_hi1336_eeprom_data.dataLength || (shine_sub_hi1336_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					printk("get eeprom data failed\n");
					if(shine_sub_hi1336_eeprom_data.dataBuffer != NULL) {
						kfree(shine_sub_hi1336_eeprom_data.dataBuffer);
						shine_sub_hi1336_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("get eeprom data success\n");
					imgSensorSetEepromData(&shine_sub_hi1336_eeprom_data);
				}
				//-Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: n21_shine_sub_hi1336@MT6765,MIPI 4LANE\n");
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_STREAMING_RESUME:
		...
		read_n21_shine_sub_hi1336_eeprom((kal_uint16)(*feature_data), 
				(char *)(uintptr_t)(*(feature_data+1)), 
				(kal_uint32)(*(feature_data+2)) );
