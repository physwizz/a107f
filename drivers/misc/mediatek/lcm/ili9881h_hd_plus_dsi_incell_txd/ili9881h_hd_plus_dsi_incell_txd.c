...
//Temp sensor initial code
{0xE0,0x01,{0x03}},//Enable Temp Sensor
{0x85,0x01,{0x7F}},//TS POWER

{0xEA,0x01,{0x3D}},//»Ý­n¶ñtrim­È
{0xEB,0x01,{0x01}},//»Ý­n¶ñTrim­È
...
{0xD2,0x01,{0xBB}},//VGH_M
{0xD3,0x01,{0xBB}},//VGH_H
{0xD4,0x01,{0x89}},//VGL_C
{0xD5,0x01,{0x89}},//VGL_L
{0xD6,0x01,{0x89}},//VGL_M
{0xD7,0x01,{0x89}},//VGL_H


// Resolution 720RGB*1520
{0xFF,0x03,{0x98,0x81,0x06}},
{0x11,0x01,{0x03}},
{0x13,0x01,{0x2C}},//+0.25%//40c1
{0x14,0x01,{0x41}},
{0x15,0x01,{0xD8}},//-0.25%//406e
{0x16,0x01,{0x40}},

{0x17,0x01,{0xFF}},
{0x18,0x01,{0x00}},

//REGISTER,20,01,15 //video command off
...
{0xE0,0x1b,{0x00,0x24,0x55,0x7C,0xAF,0x54,0xDC,0x01,0x2C,0x51,0x95,0x8B,0xB9,0xE5,0x0F,0xAA,0x3B,0x70,0x93,0xC0,0xFE,0xE6,0x1B,0x5C,0x94,0x03,0xEC}},
{0xE1,0x1b,{0x00,0x24,0x55,0x7C,0xAF,0x54,0xDC,0x01,0x2C,0x51,0x95,0x8B,0xB9,0xE5,0x0F,0xAA,0x3B,0x70,0x93,0xC0,0xFE,0xE6,0x1B,0x5C,0x94,0x03,0xEC}},

{0xFF,0x03,{0x98,0x81,0x06}},
{0xD6,0x01,{0x87}},//Êä³öTSHD 20190311
{0x27,0x01,{0x20}},//VFP
{0x28,0x01,{0x20}},//VBP
...
{0x7C,0x01,{0x40}},
{0xDD,0x01,{0x10}},//3-Lane  20190311
{0x94,0x01,{0x00}},
...
static void lcm_init(void)
{
	...
	//pr_debug("[LCM]ili9881h--txd--sm5109----init success ----\n");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	pr_debug("[txd_ili9881h]para_list[0]=%x,para_list[1]=%x\n",bl_level[1].para_list[0],bl_level[1].para_list[1]);
...
{
	pr_err("[txd_ili9881h] cabc get to %d\n", cabc_status);
	*status = cabc_status;
}
...
struct LCM_DRIVER ili9881h_hd_plus_dsi_vdo_txd_lcm_drv = {
	.name = "ili9881h_hd_plus_vdo_txd",
#endif
