...
&& !defined(CONFIG_TCPC_CLASS)
	...
	/* Do initial setting */
//+bug-529000 xiemin3.wt,add,20200108,De temperature control
...
#endif
//-bug-529000 xiemin3.wt,add,20200108,De temperature control
//EXTB P200227-00434,zhaosidong.wt,ADD,20200301,system reset funtionality
	ret = mt6370_pmu_reg_set_bit(chg_data->chip, MT6370_PMU_REG_CHGPUMP, 1<<7);
	if (ret < 0) {
		dev_err(chg_data->dev, "%s: PP_OFF_RST set 1 failed\n", __func__);
	}
