	...
	struct pd_port *pd_port, struct device_node *np)
{
	...
	struct pd_manufacturer_info *ns_mfrs_info = &pd_port->ns_mfrs_info;
#endif	/* CONFIG_USB_PD_REV30_MFRS_INFO_LOCAL */
	...
	ns_mfrs_info->vid = vid;
	ns_mfrs_info->pid = pid;
	strncpy(ns_mfrs_info->mfrs_string, "Not Supported",
		sizeof(ns_mfrs_info->mfrs_string));
#endif	/* CONFIG_USB_PD_REV30_MFRS_INFO_LOCAL */
