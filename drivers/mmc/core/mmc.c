...
//niujianmin@wt, 2019.09.27, add EMMC flash_name & vendor_name start
    ...
    switch (card->cid.manfid) {
        ...
        case 0x13:
            ...
            if (strncmp(card->cid.prod_name, "G1J9R8", strlen("G1J9R8")) == 0)
                emcp_name = "MT29VZZZAD8GQFSL_046_W_9R8";
            else
                emcp_name = NULL;
            break;
	case 0x15:
...
//niujianmin@wt, 2019.09.27, add EMMC flash_name & vendor_name end
...
static struct attribute *mmc_std_attrs[] = {
	...
	&dev_attr_ocr.attr,
	&dev_attr_dsr.attr,
	&dev_attr_flash_name.attr,  //niujianmin@wt, 2019.9.27, add
	&dev_attr_vendor.attr,      //niujianmin@wt, 2019.9.27, add
