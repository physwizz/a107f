...
int mtk_pe20_init(struct charger_manager *pinfo)
{
	...
	pinfo->pe2.profile[0].vchr = 6000000;
	pinfo->pe2.profile[1].vchr = 6500000;
	pinfo->pe2.profile[2].vchr = 7000000;
	pinfo->pe2.profile[3].vchr = 7500000;
	pinfo->pe2.profile[4].vchr = 8000000;
	pinfo->pe2.profile[5].vchr = 8500000;
